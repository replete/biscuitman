(function () {
  ...
  (function (d, w, O, h) {
    ...
    var applyCssClasses = function applyCssClasses() {
      ...
      var _iterator = _createForOfIteratorHelper(O.entries(consents)),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _step$value = _slicedToArray(_step.value, 2),
            name = _step$value[0],
            granted = _step$value[1];
    ...
    function clearStorages() {
      ...
      var _iterator2 = _createForOfIteratorHelper(O.entries(consents)),
        _step2;
      try {
        var _loop = function _loop() {
          var _step2$value = _slicedToArray(_step2.value, 2),
            section = _step2$value[0],
            sectionConsent = _step2$value[1];
          ...
          var _iterator3 = _createForOfIteratorHelper(sectionCookieNames),
            _step3;
          try {
    ...
    function insertScripts() {
      ...
      scripts.forEach(function (script) {
        ...
        var _iterator4 = _createForOfIteratorHelper(script.attributes),
          _step4;
        try {
